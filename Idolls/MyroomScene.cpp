...
//    bgayer->setContentSize(ccp(winSize.width/3200*1.8,winSize.height/4800*1.8));
    ...
    moneyMenu = CCMenu::create(money_star_button, money_coin_button, NULL);
...
void MyroomScene::schedule(){
    bglayer->getParent()->getParent()->removeChild(moneyMenu,true);
    CCScene* pScene = ScheduleScene::scene();
